...
import HomeWork5.Project.ProjectResponse;
...
public class AddDeleteUpdateIssuesAPITest {
    ...
    public void setUp() throws IOException {
        FileInputStream propertiesFile = new FileInputStream("src/test/resources/HomeWork5.properties");
        ...
        HomeWork5.Project.Status projectStatus = new HomeWork5.Project.Status(
                0,
